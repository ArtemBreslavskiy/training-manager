...
namespace TrainingManager.Migrations
{
    ...
    [Migration("20260521172117_Add-Migration fix-not-null-notes-in-exercise-and-add-notes-to-day")]
    partial class AddMigrationfixnotnullnotesinexerciseandaddnotestoday
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrainingManager.Models.WorkoutSet", b =>
                {
                    ...
                    b.Property<int>("OrderInExercises")
                        .HasColumnType("integer")
                        .HasColumnName("orderInExercises");
